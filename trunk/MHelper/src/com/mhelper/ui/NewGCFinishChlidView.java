...
public class NewGCFinishChlidView extends LinearLayout {
	...
	public NewGCFinishChlidView(Context _context, int position) {
		super(_context);
		...
		li.inflate(R.layout.new_gc_finish_chlid, this, true);
		
		alarmDate = (TextView)findViewById(R.id.gcFinishDateButton);
		alarmTime = (TextView)findViewById(R.id.gcFinishTimeButton);
		finishCheckBox = (CheckBox)findViewById(R.id.gcFinishCheckBox);
